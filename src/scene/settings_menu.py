...
class SettingsMenu(Scene):
    def __init__(self, director):
        ...
        self.effects_volume_bar = Rect(X - WIDTH // 2, Y - 100, WIDTH, VOLUME_BAR_HEIGHT)
        ...
        self.difficulty_levels = ["Facil", "Normal", "Dificil"]
    ...
    def draw(self, display_surface):
        ...
        self._draw_button(display_surface, self.difficulty_btn, f"Gamemode: {self.difficulty_levels[self.current_difficulty]}", font)
        self._draw_button(display_surface, self.resolution_btn, f"Resolution: {self.resolutions[self.current_resolution][0]}x{self.resolutions[self.current_resolution][1]}", font)
    ...
    def _draw_volume_bar(self, display_surface, rect, volume, label, font):
        ...
        draw_rect(display_surface, 'green', (rect.x, rect.y, volume * rect.width, rect.height))
