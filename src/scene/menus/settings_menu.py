...
class SettingsMenu(Menu):
    def __init__(self, director):
        ...
        self.resolution_btn_y = self.config.window_height * 0.65
        ...
        self.current_resolution = 0 if (
            self.config.window_width, self.config.window_height) == (1280, 720) else 1
    ...
    def _draw_buttons(self, display_surface):
        self.difficulty_button = draw_button_with_label(
            ...
            "Game Mode",
            self.font,
            self.difficulty_btn_y + self.config.window_height * 0.02,
        )
