...
class Background:
    """
    Gestiona el fondo del juego con efecto parallax. Permite cargar y
    mostrar imágenes de fondo que se mueven a diferentes velocidades
    según su factor de parallax. También maneja automáticamente la
    repetición del fondo para crear un efecto continuo.
    """
